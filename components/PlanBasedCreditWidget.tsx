...
import { CreditCard, ChevronDown, ChevronUp, Star, Users, Crown, Sparkles, RefreshCw } from 'lucide-react'
      ...
      >
        ...
        <div className="flex items-center space-x-2 mb-2">
          ...
          <span className="text-lg font-bold text-gray-900 dark:text-white">
            {subscription.plan.isUnlimited ? '∞' : subscription.usage.remaining}
          </span>
      ...
      {isExpanded && (
        <div className="mt-4 pt-4 border-t border-blue-200 dark:border-blue-700">
          <div className="space-y-2 text-xs text-gray-600 dark:text-gray-400">
            ...
            <div className="flex justify-between">
              <span>Plan type:</span>
              <span className="font-medium capitalize">{subscription.plan.type}</span>
            </div>
          </div>
          ...
          <div className="flex space-x-2 mt-3">
            ...
            <button 
              ...
              className="flex-1 text-center bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-xs py-2 px-3 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors disabled:opacity-50 flex items-center justify-center gap-1"
            >
